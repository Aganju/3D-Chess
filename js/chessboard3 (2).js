...
;(function() {
    ...
    function validOrdinarySquare(square) {
        ...
        return (square.search(/^[a-f]([1-9]|1[0-2])$/) !== -1);
    }
    ...
    window['ChessBoard3'] = window['ChessBoard3'] || function(containerElOrId, cfg) {
            ...
            */
            ...
            function raycast(mouseX, mouseY) {
                ...
                // Did we hit any of the boards, check the various heights
                for(var q = 2; q >= 0; q--){
                    var pos = projectOntoPlane(mouseX, mouseY, q * 3);
                    if (!pos) {
                        return {
                            source : 'offboard',
                            location: 'offboard'
            ...
            function updateLocation(raycast, mouse_x, mouse_y) {
                ...
                console.log(raycast.intersection_point);
                pos.x -= raycast.off_center_x;
                pos.z -= raycast.off_center_z;
                raycast.location = isXZOnSquare(pos.x, pos.z, pos.y);
                if (raycast.mesh.position.x !== pos.x || raycast.mesh.position.z !== pos.z || raycast.mesh.position.y !== pos.y ) {
                    raycast.mesh.position.x = pos.x;
                    raycast.mesh.position.y = pos.y;
            ...
            function snapbackDraggedPiece() {
                ...
                if (validSpareSquare(DRAG_INFO.source)) {
                    ...
                    var ty_start = DRAG_INFO.mesh.position.y;
                    ...
                    var ty_target = squareMesh.position.y;
                    var tz_target = squareMesh.position.z;
                    var end = function() {
                        DRAG_INFO.mesh.position.x = tx_target;
                        DRAG_INFO.mesh.position.y = ty_target;
                    ...
                    startTween(function(t) {
                        ...
                        DRAG_INFO.mesh.position.y = ty_start + t * (ty_target - ty_start);
            ...
            function dropDraggedPieceOnSquare() {
                ...
                DRAG_INFO.mesh.position.y = squareMesh.position.y;
            ...
            function addSquareHighlight(sq, color) {
                ...
                if (squareMesh) {
                    ...
                    highlightMesh.position.y = squareMesh.position.y + 0.2;
